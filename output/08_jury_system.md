...
```python
# Per-slot primary assignments for Reasoning jury (R) — matches §28.2 REASONING_JUDGE_SLOTS exactly:
#   judge_r1 primary: deepseek/deepseek-r1
#   judge_r2 primary: openai/o3-mini
#   judge_r3 primary: qwen/qwq-32b
#
# Per-slot fallback chains are invoked only when the primary for that slot fails.
