...
| §2.7 | Human-in-the-Loop | Human intervention at exactly 2 defined checkpoints; never more, never less |
...
CONSTRAINT = """
MUST: Pause and await human approval at EXACTLY these 2 checkpoints:
...
MUST NOT: Add additional blocking human checkpoints outside these 2.
...
**VIOLATED_BY:** Auto-approving outline when `quality_preset == "economy"`; adding per-section human approval gates.
