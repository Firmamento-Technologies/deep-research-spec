...
*Cosa conterrà: sequenza completa per ogni sezione — Researcher→Citation→Writer(MoW)→Post-Draft Analyzer→Style Linter→Content Gate(R+F)→Style Pass(S)→Style Fixer→Coherence Guard→approvazione*
...
#### 5.10 Post-Draft Research Analyzer
