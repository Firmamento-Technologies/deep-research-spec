...
export const AlertCircle: FC<IconProps> = (p) => (
  <BaseIcon {...p}>
...
export const Download: FC<IconProps> = (p) => (
  <BaseIcon {...p}>
...
export const FileText: FC<IconProps> = (p) => (
  <BaseIcon {...p}>
...
export const Lock: FC<IconProps> = (p) => (
  <BaseIcon {...p}>
...
export const Shield: FC<IconProps> = (p) => (
  <BaseIcon {...p}>
    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
  </BaseIcon>
);

export const Trash2: FC<IconProps> = (p) => (
  <BaseIcon {...p}>
...
export const Upload: FC<IconProps> = (p) => (
  <BaseIcon {...p}>
    <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
